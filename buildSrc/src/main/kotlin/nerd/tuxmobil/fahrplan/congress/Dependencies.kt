...
object Libs {
    ...
    private object Versions {
        ...
        const val junitJupiter = "5.13.4" // junit 5 is required as of android-test-core 1.8.0
        const val junitPlatform = "1.13.4" // junit 5 is required as of android-test-core 1.8.0
        const val kotlinCoroutines = "1.10.2"
        const val lifecycle = "2.9.4"
        const val markdownRenderer = "0.37.0"
