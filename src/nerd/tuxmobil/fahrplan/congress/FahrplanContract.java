...
public interface FahrplanContract {
	...
	public interface MetasTable {
		...
		public interface Columns {
			public static final String NUM_DAYS = "numdays"; 						// 0
			public static final String VERSION = "version"; 						// 1
			public static final String TITLE = "title"; 							// 2
			public static final String SUBTITLE = "subtitle"; 					// 3
			...
			public static final String ETAG = "etag"; 							// 6
		}
	...
	public interface AlarmsTable {
		...
		public interface Columns {
			...
			public static final String EVENT_TITLE = "title"; 					// 1
			public static final String ALARM_TIME_IN_MIN = "alarm_time_in_min"; 	// 2
			public static final String TIME = "time"; 							// 3
			public static final String TIME_TEXT = "timeText"; 					// 4
			public static final String EVENT_ID = "eventid"; 						// 5
			public static final String DISPLAY_TIME = "displayTime"; 				// 6
			public static final String DAY = "day"; 								// 7
		}
