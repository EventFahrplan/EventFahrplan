...
fun NetworkHttpStatus.toAppHttpStatus() = when (this) {
    ...
    NetworkHttpStatus.HTTP_LOGIN_FAIL_WRONG_PASSWORD -> AppHttpStatus.HTTP_LOGIN_FAIL_WRONG_PASSWORD
    ...
    NetworkHttpStatus.HTTP_ENTITY_ENCODING_FAILURE -> AppHttpStatus.HTTP_ENTITY_ENCODING_FAILURE
    ...
    NetworkHttpStatus.HTTP_CANCELLED -> AppHttpStatus.HTTP_CANCELLED
...
fun AppHttpStatus.toNetworkHttpStatus() = when (this) {
    ...
    AppHttpStatus.HTTP_LOGIN_FAIL_WRONG_PASSWORD -> NetworkHttpStatus.HTTP_LOGIN_FAIL_WRONG_PASSWORD
    ...
    AppHttpStatus.HTTP_ENTITY_ENCODING_FAILURE -> NetworkHttpStatus.HTTP_ENTITY_ENCODING_FAILURE
    ...
    AppHttpStatus.HTTP_CANCELLED -> NetworkHttpStatus.HTTP_CANCELLED
