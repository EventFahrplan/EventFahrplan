...
To simplify the process, please follow these suggestions:

## How to start
* Use English for all communications to include as many people as possible.
* Create an issue to discuss your idea before you spend a lot of time on designing or coding.
* Leave an `I'd like to work on this` comment on an existing issue to let the maintainer know about it.
* Fork the repository into your personal GitHub account to get started.
* Create a separate branch for each topic.

## While contributing
* Make sure to apply [automatic code formatting and organizing imports][code-formatting] as provided by Android Studio.
* Write unit tests.
...
* Describe the intent of your pull request. Include screenshots if appropriate. They help others to understand the before and after states.
...
## Translations
* Help translate the app into more languages. [Crowdin][crowdin-eventfahrplan] is used to organize all languages and texts.
* To receive a message when strings are updated please configure `Global` notifications in your [account settings][crowdin-settings-notifications]. Otherwise, you won't be notified.
